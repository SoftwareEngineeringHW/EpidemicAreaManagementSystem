...
#define REG_USER_ID_ERR           "650104000000002222"  // 已注册的用户ID
...
#define REG_ADMIN_ID              "452223199909087788"
#define REG_ADMIN_ID_ERR          "452223199909090088"  //已注册的管理员ID
#define REG_ADMIN_NAME            "哪小吒"
#define REG_ADMIN_PWD             "77887788"
#define REG_ADMIN_PHONE           "13978789898"
#define REG_ADMIN_BUILDING        "1_2"
...
#define MODIFY_EQUIP_CHANGE_SUB_MUCH "-100000"
...
#define MODIFY_EQUIPID_ERR  "{\"result\":\"1001\"}"
#define MODIFY_EQUIP_LACK   "{\"result\":\"1007\"}"
#define MODIFY_EQUIP_ERR    "{\"result\":\"-2\"}"

#define GETAPPLYSTATUS_ID_ERR         "{\"result\":1001}"
